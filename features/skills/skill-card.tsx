    ...
    >
      ...
      <div className="flex items-start gap-3.5">
        <div className="shrink-0">
          {skill.avatarUrl ? (
            <div className="overflow-hidden rounded-xl bg-muted shadow-sm border border-border/50 transition-transform group-hover:scale-105 duration-300">
              <ExternalImage
            ...
            <div className="flex size-11 items-center justify-center rounded-xl bg-gradient-to-br from-muted to-muted/50 border border-border/50 shadow-sm transition-transform group-hover:scale-105 duration-300">
