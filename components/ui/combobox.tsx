...
function ComboboxClear({ className, ...props }: ComboboxPrimitive.Clear.Props) {
  return (
    <ComboboxPrimitive.Clear
      ...
      {...props}
    >
      <X strokeWidth={2} className="pointer-events-none" aria-hidden="true" />
    </ComboboxPrimitive.Clear>
  )
}
...
function ComboboxItem({
  ...
  return (
    ...
    >
      ...
      >
        <Check strokeWidth={2} className="pointer-events-none" aria-hidden="true" />
      </ComboboxPrimitive.ItemIndicator>
    </ComboboxPrimitive.Item>
  )
}
...
function ComboboxChipsInput({
  ...
  return (
    <ComboboxPrimitive.Input
      ...
      className={cn(
        "min-w-16 flex-1 outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/30",
        className
      )}
      {...props}
    />
